...
Program Definition make_env (b: bounds) : frame_env :=
  ...
  let ol :=  align (size_callee_save_area_rec calleepairs ocs) 8 in (* locals *)
...
Local Opaque Z.add Z.mul sepconj range.
  ...
  change (size_callee_save_area_rec (callee_save_pairs (used_callee_save b)) ocs) with (size_callee_save_area fe ocs).
(* Reorder as:
     outgoing
     back link
     retaddr
